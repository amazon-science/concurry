...
class ProgressBar:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            pbar: Optional existing tqdm progress bar
            style: Progress bar style ("auto", "notebook", "std", or "ray")
            unit: Unit to display in progress bar
            color: Color of the progress bar
            ncols: Number of columns in the progress bar
            smoothing: Smoothing factor for progress updates
            total: Total number of items to process
            disable: Whether to disable the progress bar
            miniters: Minimum number of iterations between updates
            progress_bar: Progress bar configuration or existing ProgressBar instance
            prefer_kwargs: Whether to prefer kwargs over progress_bar dict
    ...
    def success(self, desc: Optional[str] = None, close: bool = True, append_desc: bool = True) -> None:
        """Mark the progress bar as successful."""
    ...
    def stop(self, desc: Optional[str] = None, close: bool = True, append_desc: bool = True) -> None:
        """Mark the progress bar as stopped."""
        self._complete_with_status(
    ...
    def failure(self, desc: Optional[str] = None, close: bool = True, append_desc: bool = True) -> None:
        """Mark the progress bar as failure."""
        self._complete_with_status(
